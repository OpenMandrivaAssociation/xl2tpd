...
%changelog
* Tue Aug 09 2011 Александр Казанцев <kazancas@mandriva.org> 1.3.0-1mdv2012.0
+ Revision: 693703
- update to 1.3.0. Drop reconnection patch due fix in upstream

* Wed Jul 20 2011 Александр Казанцев <kazancas@mandriva.org> 1.2.8-1
+ Revision: 690707
- update to 1.2.8 and add patch for high speed connection

* Thu Dec 30 2010 Александр Казанцев <kazancas@mandriva.org> 1.2.6-2mdv2011.0
+ Revision: 626233
- add reconnect failed fix patch

* Thu Sep 02 2010 Luis Daniel Lucio Quiroz <dlucio@mandriva.org> 1.2.6-1mdv2011.0
+ Revision: 575539
- 1.2.6

* Mon Sep 21 2009 Thierry Vignaud <tv@mandriva.org> 1.2.3-3mdv2010.0
+ Revision: 446195
- rebuild

  + Zombie Ryushu <ryushu@mandriva.org>
    - Fix for 2008.1 for consistant use of _localstatedir

* Tue Nov 11 2008 Zombie Ryushu <ryushu@mandriva.org> 1.2.3-1mdv2009.1
+ Revision: 302179
- New Version and First Official Mandriva Package
- New Version and First Official Mandriva Package
- import xl2tpd

  + Tomasz Pawel Gajc <tpg@mandriva.org>
    - make the spec file mdv compiliant
